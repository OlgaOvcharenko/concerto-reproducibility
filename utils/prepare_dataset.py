...
from utils.utils import py_read_data, load_meta_txt, load_meta_txt7
...
def prepare_SimulatedConcerto(data_root):
    ...
    save_path = './Batch_correction/data/expBatch1_woGroup2.loom'
    if not os.path.exists(save_path):
        os.makedirs(save_path)

    # Save in case necessary
    ...
    return adata, X, gene_name, cell_name, df_meta
    # ===========
